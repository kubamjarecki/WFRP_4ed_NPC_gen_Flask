...
class Appearence:
    """Klasa odpowiedzialna za dobranie wyglądu. Na wygląd składa się
    kolor włosów, kolor oczu oraz wygląd. Instancja tego obiektu zostaje
    dodana do obiektu Character. Wylosowane elementy są dostępne
    poprzez np. character.appearence.height.
    """
