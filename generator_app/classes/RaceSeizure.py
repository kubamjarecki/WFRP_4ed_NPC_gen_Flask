import random
from generator_app.classes.RaceTraits import RaceTraits
...
class RaceSeizure:
    ...
    def give_race(self, character):
        ...
        if character.race == "Wysoki elf":
            from generator_app.rasy.wysoki_elf import cechy, szybkosc, punkty_bohatera0, punkty_przeznaczenia0, punkty_wolne, profesje, umiejki, talentyx, wzrost, imiex_m, imiex_z, wlosy, oczy
            nazwa = character.race
        if character.race == "Leśny elf":
            from generator_app.rasy.lesny_elf import cechy, szybkosc, punkty_bohatera0, punkty_przeznaczenia0, punkty_wolne, profesje, umiejki, talentyx, wzrost, imiex_m, imiex_z, wlosy, oczy
            nazwa = character.race
        if character.race == "Krasnolud":
            from generator_app.rasy.khazad import cechy, szybkosc, punkty_bohatera0, punkty_przeznaczenia0, punkty_wolne, profesje, umiejki, talentyx, wzrost, imiex_m, imiex_z, wlosy, oczy
            nazwa = character.race
        if character.race == "Niziołek":
            from generator_app.rasy.hobbit import cechy, szybkosc, punkty_bohatera0, punkty_przeznaczenia0, punkty_wolne, profesje, umiejki, talentyx, wzrost, imiex_m, imiex_z, wlosy, oczy
            nazwa = character.race
        if character.race == "Człowiek":
            from generator_app.rasy.czlowiek import cechy, szybkosc, punkty_bohatera0, punkty_przeznaczenia0, punkty_wolne, profesje, umiejki, talentyx, wzrost, imiex_m, imiex_z, wlosy, oczy
            nazwa = character.race
