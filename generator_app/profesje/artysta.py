...
umiejkip= ["Mocna Głowa (Wt)", "Odporność (Wt)", "Opanowanie (SW)", "Percepcja (I)", "Plotkowanie (Ogd)", "Skradanie (Zw) (Miasto)", "Sztuka (Zr) (Dowolna)", "Wycena (Int)"]
...
umiejkip= ["Język (Int) (Klasyczny)", "Hazard (Int)", "Intuicja (I)", "Targowanie (Ogd)", "Wspinaczka (S)", "Rzemiosło (Zr) (Przybory dla artystów)"]
...
umiejkip= ["Charyzma (Ogd) ", "Dowodzenie (Ogd)", "Wiedza (Int) (Sztuka (Zr))", "Wiedza (Int) (Heraldyka)"]
...
umiejkip= ["Badania Naukowe (Int)", "Jeździectwo (Zw)  (Konie)"]
for um in umiejkip:
    if um in slownik_umiejetnosci_oraz_levelu:
        um = um + " "
...
wyp4 = ["biblioteka (Sztuka (Zr))", "duży warsztat (Artysty)", "3 Uczniów"]
