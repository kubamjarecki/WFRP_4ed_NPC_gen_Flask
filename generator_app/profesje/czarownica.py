...
umiejkip= ["Język (Int) (Magiczny)", "Odporność (Wt)", "Opanowanie (SW),Plotkowanie (Ogd)", "Skradanie (Zw) (Wieś)", "Splatanie Magii (SW)", "Zastraszanie (S)", "Zwinne Palce (Zr)"]
...
umiejkip= ["Broń Biała (WW) (Drzewcowa)", "Intuicja (I)", "Oswajanie (SW)", "Percepcja (I)", "Rzemiosło (Zr) (Zielarz)", "Unik (Zw)"]
...
umiejkip= ["Charyzma (Ogd) ", "Przekupstwo (Ogd)", "Targowanie (Ogd)", "Wiedza (Int) (Mroczna Magia)"]
...
umiejkip= ["Wiedza (Int) (Demonologia)", "Wiedza (Int) (Magia)"]
for um in umiejkip:
    if um in slownik_umiejetnosci_oraz_levelu:
        um = um + " "
