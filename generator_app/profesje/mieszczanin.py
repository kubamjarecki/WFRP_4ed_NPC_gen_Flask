...
umiejkip= ["Charyzma (Ogd) ", "Hazard (Int)", "Mocna Głowa (Wt)", "Powożenie (Zw)", "Plotkowanie (Ogd)", "Targowanie (Ogd)", "Unik (Zw)", "Wspinaczka (S)"]
...
umiejkip= ["Broń Biała (WW) (Bijatyka)", "Intuicja (I)", "Muzyka (Zr) (Dowolna)", "Przekupstwo (Ogd)", "Wiedza (Int) (Lokalna)", "Wycena (Int)"]
...
umiejkip= ["Badania Naukowe (Int)", "Opanowanie (SW)", "Percepcja (I)", "Wiedza (Int) (Prawo)"]
...
umiejkip= ["Wiedza (Int) (Polityka)", "Zastraszanie (S)"]
for um in umiejkip:
    if um in slownik_umiejetnosci_oraz_levelu:
        um = um + " "
