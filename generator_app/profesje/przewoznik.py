...
umiejkip= ["Broń Biała (WW) (Bijatyka)", "Mocna Głowa (Wt)", "Odporność (Wt)", "Plotkowanie (Ogd)", "Pływanie (S)", "Unik (Zw)", "Wioślarstwo (S)", "Żeglarstwo (Zw)"]
...
umiejkip= ["Atletyka (Zw)", "Intuicja (I)", "Percepcja (I)", "Targowanie (Ogd)", "Wiedza (Int) (Szlaki Rzeczne)", "Występy (Ogd) (Gawędziarstwo)"]
...
umiejkip= ["Leczenie (Int)", "Rzemiosło (Zr) (Szkutnictwo)", "Wspinaczka (S)", "Występy (Ogd) (Śpiewanie)"]
...
umiejkip= ["Dowodzenie (Ogd)", "Nawigacja (I)"]
for um in umiejkip:
    if um in slownik_umiejetnosci_oraz_levelu:
        um = um + " "
