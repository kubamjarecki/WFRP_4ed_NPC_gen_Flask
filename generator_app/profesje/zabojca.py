...
umiejkip= ["Broń Biała (WW) (Podstawowa)", "Hazard (Int)", "Leczenie (Int)", "Mocna Głowa (Wt)", "Odporność (Wt)", "Opanowanie (SW)", "Unik (Zw)", "Wiedza (Int) (Trolle)"]
...
umiejkip= ["Broń Biała (WW) (Dwuręczna)", "Język (Int) (Bitewny)", "Sztuka Przetrwania (Int)", "Wiedza (Int) (Olbrzymy)", "Wycena (Int)", "Zastraszanie (S)"]
...
umiejkip= ["Broń Zasięgowa (US) (Miotana)", "Percepcja (I)", "Wiedza (Int) (Smoki)", "Występy (Ogd) (Gawędziarstwo)"]
...
umiejkip= ["Intuicja (I)", "Wiedza (Int) (Chaos)"]
for um in umiejkip:
    if um in slownik_umiejetnosci_oraz_levelu:
        um = um + " "
