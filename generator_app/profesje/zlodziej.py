...
umiejkip= ["Atletyka (Zw)", "Intuicja (I)", "Odporność (Wt)", "Opanowanie (SW),Percepcja (I)", "Skradanie (Zw) (Miasto)", "Unik (Zw)", "Wspinaczka (S)"]
...
umiejkip= ["Otwieranie Zamków (Zr)", "Plotkowanie (Ogd)", "Sekretne Znaki (Int) (Złodziei)", "Wiedza (Int) (Lokalna)", "Wycena (Int)", "Zwinne Palce (Zr)"]
...
umiejkip= ["Broń Zasięgowa (US) (Kusza)", "Hazard (Int)", "Przekupstwo (Ogd)", "Zastraszanie (S)"]
...
umiejkip= ["Charyzma (Ogd) ", "Zastawianie Pułapek (Zr)"]
for um in umiejkip:
    if um in slownik_umiejetnosci_oraz_levelu:
        um = um + " "
