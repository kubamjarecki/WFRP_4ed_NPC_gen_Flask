...
def  losowanie_imienia(string):
    ...
    if string == "Mężczyzna":
        lista = ["Adhemar", "Anders", "Artur", "Beatrijs", "Clementia", "Detlev", "Frederich", "Gerner", "Gertraud", "Haletha", "Heinrich", "Henryk", "Karl", "Kruger", "Marieke", "Sebastien", "Talther", "Talunda", "Ulrich", "Werther", "Wilryn", "Adelbert", "Adolf", "Adolphus", "Albert", "Albrecht", "Adhelm", "Alex", "Alexei", "Alfred", "Alfricht", "Anders", "Andreas", "Anton,", "Arthur", "Axel", "Barthelm", "BengtS", "Bernhard", "Berthold", "Bogoslav", "Boris", "Bruno", "Carolus", "Karl", "Klaus", "Konrad", "Diehl", "Dieter", "Dietrich", "Eberhard,", "Eckhard", "Edgar", "Ehrhard", "Ehrmann", "Emmerich", "Erich", "Ernst", "Erwin", "Faustmann", "Felix", "Ferdinand", "Franz", "Friedrich", "Fritz", "Frederik", "Gebhard", "Georg", "Gerhard", "Gottfried", "Gotthard", "Gottlieb", "Gregor", "Gunnar", "Gunther", "Gustav", "Gustavus", "Hals", "Hannes", "Hans", "Hartwig", "Heinrich", "Heinz", "Hieronymus", "Helmut", "Hergard", "Herman", "Herpin", "Hildebrand", "HolgerS", "Hugo", "Hultz", "Humfried", "Jakob", "Joachim", "Johann", "Johannes", "Josef", "Kaspar", "Kastor", "KnnudS", "Kurt", "Lorenz", "Leonard", "Luitpold", "Ludovicus", "Ludwig", "Lukas", "Magnus", "Mannfred", "Mannricht", "Mannsfried", "Mannslieb", "Martin", "Matthias", "Maximillian", "Melched", "Moritz", "Nikolas", "Nikolaus", "OlafS", "Oskar", "Otto", "Paul", "Paulus", "Peter", "Pieter", "Quintus", "Ralf", "Randolf", "Ranelf", "Rannalt", "RolfS", "Reinald", "Reiner", "Reinhard", "Reinhold", "Reinwald", "Rudiger", "Rutger", "Rudolf", "Ruprecht", "Seiger", "Siegfried", "Sigismund", "Sigmund", "Stehmar", "Stephan", "Talecht", "Thedosius", "Theopilius", "Thomas", "Tobias", "Udo", "Uhler", "Ulfred", "Ulli", "Ulrich", "Ulrict", "Viktor", "Vorster", "Waldemar", "Walter", "Werner", "Wilhelm", "Wolf", "Wolfgang", "Wolmar"]



    nazwisko = ["Müller", "Schneider", "Fischer", "Weber", "Meier", "Wagner", "Bäcker", "Hofmann", "Schäfer", "Koch",
                "Bauer", "Richter", "Klein", "Wolf", "Schwarz", "Zimmermann", "Braun", "Lange", "Fuchs", "Kaiser",
                "König", "Krause", "Köhler", "Schuhmacher", "Schmidt", "Beinbruch", "Bendow", "Bennefeld", "Bennefeldt",
                "Berger", "Bergmann", "Bernecker", "Bildt", "Braun", "Breitner", "Breull", "Bruckner", "Backer",
                "Dessau", "Dietz", "Dreschel", "Drucker", "Dudenbostel", "Dunkelberg", "Eberhauer", "Eckhard",
                "Eichheim", "Engelhart", "Engelmann", "Errlich", "Faustmann", "Finck", "Flaschmann", "Fleischer",
                "Flick", "Fraunhofer", "Fredersdorff", "Ganghofer", "Gebiihr", "Geldrecht", "Geller", "Genscher",
                "Gerber", "Gesner", "Goebbels", "Goffmann", "Gruber", "Griin", "Griinberg", "Gunzenhauser",
                "Hackenbusch", "Haffenheim", "Haffmeister", "Hannicke", "Hardenberg", "Hartmann", "Haufmann",
                "Heilborn", "Heising", "Hellbach", "Herrscher", "Heschendorf", "Heuser", "Hindenburg", "Hockmann",
                "Hohenberg", "Holstweig", "Hostettler", "Huber", "Hubergreiber", "Hollmer", "Horbiger", "Immelmann",
                "Junkermann", "Jager", "Kerzer", "Kessler", "Kesselmann", "Kesselring", "Kiefern", "Kirchner",
                "Kleemann", "Kleist", "Kleiter", "Klipstein", "Korff", "Krause", "Kreutzmann", "Kriiger", "Kunz",
                "Kupfer", "Kurz", "Korbitz", "Koster", "Lepr", "Leibelt", "Lentz", "Leonhardt", "Liebeneiner",
                "Liebowitz", "Lindenlaub", "Lizt", "Lohrentzen", "Luchter", "Meyer", "Meinhard", "Meissen",
                "Merkwiirdigliebe", "Mierendorff", "Miiller", "Nordberg", "Osterwald", "Platen", "Prasch", "Prunkvoll",
                "Pollnitz", "Rabenfels", "Regelsberg", "Reitsmann", "Retzer", "Richsteiger", "Riedmann", "Rosenkrantz",
                "Rupp", "Schatzenheimer", "Schicklgruber", "Schiller", "Schimmel", "Schlichter", "Schlichtkrull",
                "Schmidhuber", "Schmidt", "Schmiedehammer", "Schneider", "Schroder", "Schumacher", "Schutzmann",
                "Schwarz", "Schwarzberg", "Schwarzkopf", "Schwensen", "Schiinzel", "Schon", "Seefeldt", "Seydlitz",
                "Sonnefeld", "Stadtmiiller", "Steiger", "Stein", "Steinbocka", "Steinmeyer", "Sternheimer", "Stiefel",
                "Streckmann", "Stiiwe", "Vespermann", "Vogel", "Voller", "Wagner", "Wassmeier", "Geissbach"]
