import unittest
from generator_app.classes.ProfessionTraits import ProfessionTraits
from generator_app.profesje.agitator import klasa, nazwa_profesji, status, rozwiniecia_cech, waga, slownik_umiejetnosci_oraz_levelu, talenty, wyp
